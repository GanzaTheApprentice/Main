...
START_TEST(plus) {
  ...
  char x[255] = "\0";
  ck_assert_str_eq(calc(arr, x), "1804274999972.63012695");
}
END_TEST
...
START_TEST(cos2) {
  ...
  char x[255] = "-10";
  ck_assert_str_eq(calc(arr, x), "-0.91113026");
}
END_TEST
...
START_TEST(sin2) {
  ...
  char x[255] = "-10";
  ck_assert_str_eq(calc(arr, x), "0.99999021");
}
END_TEST
...
START_TEST(tan2) {
  ...
  char x[255] = "-10";
  ck_assert_str_eq(calc(arr, x), "0.64836083");
}
END_TEST
...
START_TEST(acos2) {
  ...
  char x[255] = "-0.1";
  ck_assert_str_eq(calc(arr, x), "1.56079616");
}
END_TEST
...
START_TEST(asin2) {
  ...
  char x[255] = "-0.1";
  ck_assert_str_eq(calc(arr, x), "-0.05002086");
}
END_TEST
...
START_TEST(testatan2) {
  ...
  char x[255] = "-0.1";
  ck_assert_str_eq(calc(arr, x), "-0.00000000");
}
END_TEST
...
START_TEST(sqrt2) {
  ...
  char x[255] = "-10";
  ck_assert_str_eq(calc(arr, x), "incorrect input");
}
END_TEST
...
START_TEST(ln2) {
  char arr[255] = "ln(x)";
  char x[255] = "-10";
  ck_assert_str_eq(calc(arr, x), "nan");
}
END_TEST
...
START_TEST(cos1) {
  char arr[255] = "-cos(x)";
  char x[255] = "-10";
  ck_assert_str_eq(calc(arr, x), "0.83907153");
}
END_TEST
...
START_TEST(sin1) {
  char arr[255] = "-sin(25)";
  char x[255] = "-10";
  ck_assert_str_eq(calc(arr, x), "0.13235175");
}
END_TEST
...
START_TEST(tan1) {
  ...
  char x[255] = "-10";
  ck_assert_str_eq(calc(arr, x), "0.85594117");
}
END_TEST
...
START_TEST(atan1) {
  char arr[255] = "-atan(x)";
  char x[255] = "-10";
  ck_assert_str_eq(calc(arr, x), "1.47112767");
}
END_TEST
...
START_TEST(ymnojenie) {
  ...
  char x[255] = "-10";
  ck_assert_str_eq(calc(arr, x), "-121.20000000");
}
END_TEST
